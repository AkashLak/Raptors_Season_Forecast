...
# Add parent folder to Python path for imports
...
X, y = load_and_prepare_data()  # Returns features matching trained model (with lagged features)
...
# Drop any rows with NaNs in lag features (usually the first row)
...
year = st.sidebar.slider(
    ...
    max_value=int(X['year'].max()) + 1,  # Allow predicting next season
